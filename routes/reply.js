...
router.post("/upload", [authJwt.verifyToken], upload.single('image'), replyCtrl.createReply);
...
router.put("/:idObject", [authJwt.verifyToken], upload.single('image'), replyCtrl.modifyReply);
